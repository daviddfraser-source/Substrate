...
def run_cli(*args):
    cmd = ["python3", str(GOV / "wbs_cli.py"), *args, "--json"]
...
def main() -> int:
    ...
    agent_supplement = ROOT / "AGENTS.session.md"
    ...
    claude_supplement = ROOT / "CLAUDE.session.md"
    ...
    print("Generated: .governance/session-brief.json, docs/session-brief.md, AGENTS.session.md, CLAUDE.session.md")
    return 0
