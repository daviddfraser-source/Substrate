...
- AI harness (`scripts/run-ai-eval.py`, `reports/ai-substrate-eval.json`)
...
2. Run `scripts/run-ai-eval.py` after major schema changes and checkpoint `reports/ai-substrate-eval.json`.
