import { RolePermissions, WbsPacketRow } from "./wbsGridTypes";
...
export function applyInlineEdit(row: WbsPacketRow, field: "owner" | "priority" | "status", value: string, permissions: RolePermissions): WbsPacketRow {
...
export function applyBulkAction(rows: WbsPacketRow[], request: BulkActionRequest, permissions: RolePermissions): WbsPacketRow[] {
